...
@SuppressLint("NewApi")
public class EditionFragment3 extends Fragment {
	private static final String TAG = "Newsstand";
	private static EditionFragment3 mEditionFragment;
	...
	ActionIndicator mActionIndicator;

	public static void show(FragmentManager fm, ViewGroup actionBarView) {
		final FragmentTransaction ft = fm.beginTransaction();
		mEditionFragment = new EditionFragment3();
		EditionFragment3.mActionBarView = actionBarView;
	...
	public static void onTouchEvent(MotionEvent event) {
		final EditionFragment3 ef = mEditionFragment;
		if (null != ef) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mActionIndicator = new ActionIndicator(mContext, 0, 0,
